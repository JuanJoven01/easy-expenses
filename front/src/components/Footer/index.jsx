    ...
    const linksToContact = [
        {
            ...
            'image': <FaSquareGithub className="h-12 w-12 text-slate-400 mx-3"/>,
        ...
        },
        {
            ...
            'image': <FaLinkedin className="h-12 w-12 text-blue-500 mx-3"/>,
        ...
        },
        {
            ...
            'image': <FaSquareWhatsapp className="h-12 w-12 mx-3 text-green-600"/>,
            'shadow': 'drop-shadow-[0px_0px_10px_rgba(0,130,100,0.6)]',
            'shadow_hover':  'hover:drop-shadow-[0px_0px_13px_rgba(0,130,100,0.8)]',
        }
    ]
    return (
        <footer className="border-t-2 border-slate-500 flex bg-slate-900 h-14 justify-center center">
            {
